...
public class User implements Serializable {
    ...
    private static final long serialVersionUID = 28932022L;
    ...
    public boolean isLoggedIn() {
        System.out.println("checking login: " + studentID + " " + this.toString());
        if (studentID == -1) {
            return false;
        }
        return true;
    ...
    {
        setStudentID(1);
        System.out.println("logging in: " + studentID + " " + this.toString());
    }
}